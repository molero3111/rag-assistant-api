...
DB_NAME = os.getenv('POSTGRES_DB', 'tutor_db')
DB_USER = os.getenv('POSTGRES_USER', 'tutor_user')
...
# Summarizer config (tune as needed)
SUMMARIZER_MAX_TOKENS = int(os.getenv("SUMMARIZER_MAX_TOKENS", 2048))
SUMMARIZER_MAX_SUMMARY_TOKENS = int(os.getenv("SUMMARIZER_MAX_SUMMARY_TOKENS", 512))
SUMMARIZER_MAX_TOKENS_BEFORE_SUMMARY = int(os.getenv("SUMMARIZER_MAX_TOKENS_BEFORE_SUMMARY", 20000))